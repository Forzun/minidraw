...
export default function MiniHero( ){ 
    ...
    return <>
           ...
           <div className="flex items-center justify-center gap-3 md:mt-7 mt-5">
               <Button className="w-full md:py-3 bg-gradient-to-r from-neutral-100 to-zinc-200" variant={"secondary"}>Get Started for free
               <ArrowRight className="text-neutral-800" />
              </Button> 
           </div>
            <div className="md:mt-[8rem] mt-[3rem] p-5  mask-b-from-20% mask-b-to-80%"> 
                <div className="relative">
                   <Image className="border relative border-neutral-600 rounded-md " alt="heroDark" width={1100} height={100} src={"/hero-dark.png"} />
